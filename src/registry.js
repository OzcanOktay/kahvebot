...
class CommandoRegistry {
	...
	registerDefaultCommands(commands = {}) {
		...
		if(commands.help) this.registerCommand(require('./commands/util/yardım'));
		if(commands.prefix) this.registerCommand(require('./commands/ayarlar/prefix'));
		if(commands.ping) this.registerCommand(require('./commands/util/ping'));
		if(commands.eval) this.registerCommand(require('./commands/admin/eval'));
		return this;
	}
